                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-2">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">حالات الحجز</li>
                            </ol>
                        </nav>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#html5-extension').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('dashboard.booking_statuses.index')); ?>',
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
        ...
        $(document).on('click', '#edit-booking-status', function () {
            ...
            let action = "<?php echo e(route('dashboard.booking_statuses.update', 'id')); ?>";
...
<?php echo $__env->make('dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/974206.cloudwaysapps.com/xzgdmzdxcn/public_html/resources/views/dashboard/booking_statuses/index.blade.php ENDPATH**/ ?>