                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-2">
                                <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard.home')); ?>"><?php echo e(__('dash.dashboard')); ?></a></li>
                            </ol>
                        </nav>
                        ...
                        <div class="widget widget-one_hybrid widget-followers">
                            <div class="widget-heading">
                                <div class="w-title">
                                    ...
                                    <div class="">
                                        <p class="w-value"><?php echo e($customers); ?></p>
                                        <h5 class="">العملاء</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="widget widget-one_hybrid widget-referral">
                            <div class="widget-heading">
                                <div class="w-title">
                                    ...
                                    <div class="">
                                        <p class="w-value"><?php echo e($orders); ?></p>
                                        <h5 class="">الطلبات</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="widget widget-one_hybrid widget-engagement">
                            <div class="widget-heading">
                                <div class="w-title">
                                    ...
                                    <div class="">
                                        <p class="w-value"><?php echo e($technicians); ?></p>
                                        <h5 class="">الفنيين</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="widget widget-one_hybrid widget-engagement">
                            <div class="widget-heading">
                                <div class="w-title">
                                    ...
                                    <div class="">
                                        <p class="w-value"><?php echo e($booking); ?></p>
            ...
            <div class="col-xl-6 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    ...
                    <table id="html5-extension-order" class="table table-hover non-hover" >
                        ...
                        <tr>
                            <th>#</th>
                            <th><?php echo e(__('dash.customer_name')); ?></th>
                            <th><?php echo e(__('dash.quantity')); ?></th>
                            <th><?php echo e(__('dash.price_value')); ?></th>
                        </tr>
                        </thead>
                    </table>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#html5-extension').DataTable({
                ...
                responsive: true,
                serverSide: true,
                ajax: '<?php echo e(route('dashboard.bookings.index')); ?>',
                columns: [
        ...
        $(document).ready(function () {
            $('#html5-extension-order').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('dashboard.orders.index')); ?>',
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'user', name: 'user'},
...
<?php echo $__env->make('dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/974206.cloudwaysapps.com/xzgdmzdxcn/public_html/resources/views/dashboard/home.blade.php ENDPATH**/ ?>