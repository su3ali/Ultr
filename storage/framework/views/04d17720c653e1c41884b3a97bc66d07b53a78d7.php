<?php $__env->startSection('sub-header'); ?>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-2">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('dash.Cities')); ?></li>
                            </ol>
                        </nav>
    ...
    <?php echo $__env->make('dashboard.settings.cities.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('dashboard.settings.cities.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#html5-extension').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('dashboard.city.index')); ?>',
                columns: [
                    {data: 'id', name: 'id'},
        ...
        $("body").on('change', '#customSwitch4', function () {
            ...
            $.ajax({
                url: '<?php echo e(route('dashboard.city.change_status')); ?>',
                type: 'get',
...
<?php echo $__env->make('dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/974206.cloudwaysapps.com/xzgdmzdxcn/public_html/resources/views/dashboard/settings/cities/index.blade.php ENDPATH**/ ?>