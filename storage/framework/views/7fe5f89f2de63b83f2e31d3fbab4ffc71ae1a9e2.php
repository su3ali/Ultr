                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-2">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('dash.Regions')); ?></li>
                            </ol>
                        </nav>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="col-md-12 text-right mb-3">
                        ...
                        <a href="<?php echo e(route('dashboard.region.create')); ?>" class="btn btn-primary"><?php echo e(__('dash.add_new')); ?></a>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#html5-extension').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('dashboard.region.index')); ?>',
                columns: [
                    {data: 'id', name: 'id'},
        ...
        $("body").on('click', '.edit', function () {
            ...
            var action = window.location.origin + '/admin/settings/region/' + id;
            console.log(action)
        ...
        $("body").on('change', '#customSwitch4', function () {
            ...
            $.ajax({
                url: '<?php echo e(route('dashboard.region.change_status')); ?>',
                type: 'get',
...
<?php echo $__env->make('dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/974206.cloudwaysapps.com/xzgdmzdxcn/public_html/resources/views/dashboard/settings/regions/index.blade.php ENDPATH**/ ?>