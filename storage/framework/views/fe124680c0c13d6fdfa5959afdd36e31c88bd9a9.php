            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6" style="min-height: 500px;">
                    <div class="col-md-12 text-left mb-3">
                        <h3>إنشاء باقه جديد</h3>
                    </div>
                    <div class="col-md-12">
                        <form action="<?php echo e(route('dashboard.contract_packages.store')); ?>" method="post" class="form-horizontal"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input required name="name_en" type="text" placeholder="اسم الباقة بالانجليزي" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input required type="number" step="0.1" name="visit_number" class="form-control"
                                               id="visit_number"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input required name="time" type="text" placeholder="الفترة" class="form-control">
...
<?php echo $__env->make('dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/974206.cloudwaysapps.com/xzgdmzdxcn/public_html/resources/views/dashboard/contract_packages/create.blade.php ENDPATH**/ ?>