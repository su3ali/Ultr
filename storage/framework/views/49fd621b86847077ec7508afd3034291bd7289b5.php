    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#html5-extension').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('dashboard.order_statuses.index')); ?>',
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
        ...
        $(document).on('click', '#edit-order-status', function () {
            ...
            let action = "<?php echo e(route('dashboard.order_statuses.update', 'id')); ?>";
        ...
        $("body").on('change', '#customSwitchStatus', function () {
            ...
            $.ajax({
                url: '<?php echo e(route('dashboard.order_statuses.change_status')); ?>',
                type: 'get',
...
<?php echo $__env->make('dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/974206.cloudwaysapps.com/xzgdmzdxcn/public_html/resources/views/dashboard/order_statuses/index.blade.php ENDPATH**/ ?>