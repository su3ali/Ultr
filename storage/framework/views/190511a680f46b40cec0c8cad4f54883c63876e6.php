            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="col-md-12 text-right mb-3">
                        ...
                        <a href="<?php echo e(route('dashboard.booking_setting.create')); ?>" class="btn btn-primary"><?php echo e(__('dash.add_new')); ?></a>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#html5-extension').DataTable({
                ...
                responsive: true,
                serverSide: true,
                ajax: '<?php echo e(route('dashboard.booking_setting.index')); ?>',
                columns: [
                    {data: 'id', name: 'id'},
...
<?php echo $__env->make('dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/974206.cloudwaysapps.com/xzgdmzdxcn/public_html/resources/views/dashboard/booking_settings/index.blade.php ENDPATH**/ ?>