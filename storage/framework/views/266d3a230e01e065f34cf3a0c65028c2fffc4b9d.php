                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-2">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="<?php echo e(route('dashboard.core.address.index','id='.request('id'))); ?>"><?php echo e(__('dash.user addresses')); ?></a>
                                </li>
        ...
        <div class="row layout-top-spacing">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <form  method="post"
                           action="<?php echo e(route('dashboard.core.address.store')); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="address" class="form-control"
                                       id="inputEmail4"
                                       placeholder="<?php echo e(__('dash.address')); ?>">
...
<?php echo $__env->make('dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\sahmTech\Altra\resources\views/dashboard/core/addresses/create.blade.php ENDPATH**/ ?>