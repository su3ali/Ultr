                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-2">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="<?php echo e(route('dashboard.orders.index')); ?>">الطلبات</a></li>
        ...
        <div class="row layout-top-spacing">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6" style="min-height: 400px;">
                    ...
                    <?php echo $__env->make('dashboard.orders.createUser', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                    <div class="col-md-12">
                        <form action="<?php echo e(route('dashboard.orders.store')); ?>" method="post" class="form-horizontal"
                            ...
                            <div class="box-body">
                                <div class="form-row mb-3">
                                    <div class="form-group col-md-6">
                                        ...
                                        <label for="customer_name"><?php echo e(__('dash.customer_name')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php echo $__env->make('dashboard.orders.serviceTable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                                <?php echo $__env->make('dashboard.orders.time', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mt-4">
                                                <?php echo Form::label('payment_method_visa', 'طريقة الدفع'); ?>
...
<?php $__env->startPush('script'); ?>
    ...
    <script type="text/javascript">
        ...
        $('body').ready(function () {
            $('#customer_name').select2({
                ...
                ajax: {
                    url: "<?php echo e(route('dashboard.order.autoCompleteCustomer')); ?>",
    ...
    <script>
        ...
        $('body').on('change', '#getData', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('dashboard.order.getAvailableTime')); ?>",
                data: {
                    'date': Data,
        ...
        function callMe() {
            ...
            $('.name-' + hidden_itr).autocomplete({
                source: function (request, response) {
                    // Fetch data
                    $.ajax({
                        url: "<?php echo e(route('dashboard.order.autoCompleteService')); ?>",
                        type: 'get',
                        dataType: "json",
                        data: {
                            q: request.term,
...
<?php echo $__env->make('dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/974206.cloudwaysapps.com/xzgdmzdxcn/public_html/resources/views/dashboard/orders/create.blade.php ENDPATH**/ ?>