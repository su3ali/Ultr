    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('dashboard.reason_cancel.store')); ?>" method="post" class="form-horizontal"
...
<?php /**PATH /home/974206.cloudwaysapps.com/xzgdmzdxcn/public_html/resources/views/dashboard/reason_cancel/create.blade.php ENDPATH**/ ?>