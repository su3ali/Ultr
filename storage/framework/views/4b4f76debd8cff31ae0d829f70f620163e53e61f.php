<?php $__env->startSection('sub-header'); ?>
    ...
    <?php echo $__env->make('dashboard.reason_cancel.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('dashboard.reason_cancel.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#html5-extension').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('dashboard.reason_cancel.index')); ?>',
                columns: [
                    {data: 'id', name: 'id'},
        ...
        $(document).on('click', '#add-work-exp', function () {
            ...
            let action = "<?php echo e(route('dashboard.reason_cancel.update', 'id')); ?>";
        ...
        $("body").on('change', '#customSwitchStatus', function () {
            ...
            $.ajax({
                url: '<?php echo e(route('dashboard.reason_cancel.change_status')); ?>',
                type: 'get',
...
<?php echo $__env->make('dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/974206.cloudwaysapps.com/xzgdmzdxcn/public_html/resources/views/dashboard/reason_cancel/index.blade.php ENDPATH**/ ?>