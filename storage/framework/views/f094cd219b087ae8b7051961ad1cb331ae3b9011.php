                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-2">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">إنشاء ايقونه</li>
                            </ol>
                        </nav>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6" style="min-height: 400px;">
                    <div class="col-md-12 text-left mb-3">
                        <h3>إنشاء ايقونه جديد</h3>
                    </div>
                    <div class="col-md-12">
                        <form action="<?php echo e(route('dashboard.core.icon.store')); ?>" method="post" class="form-horizontal"
...
<?php echo $__env->make('dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\tcavw\Desktop\Sahmtech\Ultra\public_html\resources\views/dashboard/core/icon/create.blade.php ENDPATH**/ ?>