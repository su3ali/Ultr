<?php $__env->startSection('sub-header'); ?>
    ...
    <?php echo $__env->make('dashboard.core.groups.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('dashboard.core.groups.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
    ...
    <script>
        $(document).ready(function (){
            $('.country_id').on('change',function (){
                ...
                $.ajax({
                    url: '<?php echo e(route('dashboard.core.address.getCity')); ?>',
                    data:{country_id:country_id},
                    success: function(response) {
                        $('.city_id').empty()
                        $('.city_id').append('<option disabled selected><?php echo e(__('dash.choose')); ?></option>')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#html5-extension').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('dashboard.core.group.index')); ?>',
                columns: [
                    {data: 'id', name: 'id'},
        ...
        $(document).on('click', '#edit-techGroup', function () {
            ...
            let action = "<?php echo e(route('dashboard.core.group.update', 'id')); ?>";
        ...
        $("body").on('change', '#customSwitch4', function () {
            ...
            $.ajax({
                url: '<?php echo e(route('dashboard.core.group.change_status')); ?>',
                type: 'get',
...
<?php echo $__env->make('dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/974206.cloudwaysapps.com/xzgdmzdxcn/public_html/resources/views/dashboard/core/groups/index.blade.php ENDPATH**/ ?>