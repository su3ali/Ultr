                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-2">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">الايقونات</li>
                            </ol>
                        </nav>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="col-md-12 text-right mb-3">
                        ...
                        <a href="<?php echo e(route('dashboard.core.icon.create')); ?>" id="" class="btn btn-primary card-tools">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#html5-extension').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('dashboard.core.icon.index')); ?>',
                columns: [
                    {data: 'id', name: 'id'},
        ...
        $("body").on('change', '#customSwitch4', function () {
            ...
            $.ajax({
                url: '<?php echo e(route('dashboard.core.icon.change_status')); ?>',
                type: 'get',
...
<?php echo $__env->make('dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/974206.cloudwaysapps.com/xzgdmzdxcn/public_html/resources/views/dashboard/core/icon/index.blade.php ENDPATH**/ ?>