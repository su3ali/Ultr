        ...
        <div class="row layout-top-spacing">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <form action="<?php echo e(route('dashboard.region.update',$region->id)); ?>" method="post" class="form-horizontal"
                        ...
                        <div class="box-body">
                            <div class="form-row mb-3">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="title_ar" value="<?php echo e($region->title_ar); ?>" class="form-control"
                                           id="inputEmail4"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="title_en" value="<?php echo e($region->title_en); ?>" class="form-control"
                                           id="inputEmail4"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="inputState" class="select2 form-control pt-1"
                                        ...
                                        <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>" <?php if($key == $region->city_id): ?> selected <?php endif; ?> ><?php echo e($city); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="space_km" value="<?php echo e($region->space_km); ?>" class="form-control"
                                           id="inputEmail4"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="lat" value="<?php echo e($region->lat); ?>" class="lat form-control"
                                           id="inputEmail4"
                                           placeholder="lat"
                                    >
                                    <?php $__errorArgs = ['lat'];
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="lon" value="<?php echo e($region->lon); ?>" class="lon form-control"
                                           id="inputEmail4"
                                           placeholder="lon"
                                    >
                                    <?php $__errorArgs = ['lon'];
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        ...
        function initMap() {
            var center = {lat: <?php echo e($region->lat); ?>, lng: <?php echo e($region->lon); ?>};
...
<?php echo $__env->make('dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/974206.cloudwaysapps.com/xzgdmzdxcn/public_html/resources/views/dashboard/settings/regions/edit.blade.php ENDPATH**/ ?>