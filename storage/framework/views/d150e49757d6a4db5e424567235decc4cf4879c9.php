<?php $__env->startSection('sub-header'); ?>
    ...
    <?php echo $__env->make('dashboard.settings.faqs.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('dashboard.settings.faqs.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#html5-extension').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('dashboard.faqs.index')); ?>',
                columns: [
                    {data: 'id', name: 'id'},
        ...
        $(document).on('click', '#edit-faq', function () {
            ...
            let action = "<?php echo e(route('dashboard.faqs.update', 'id')); ?>";
        ...
        $("body").on('change', '#customSwitchStatus', function () {
            ...
            $.ajax({
                url: '<?php echo e(route('dashboard.faqs.change_status')); ?>',
                type: 'get',
...
<?php echo $__env->make('dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/974206.cloudwaysapps.com/xzgdmzdxcn/public_html/resources/views/dashboard/settings/faqs/index.blade.php ENDPATH**/ ?>