<?php $__env->startSection('sub-header'); ?>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-2">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('dash.technicians')); ?></li>
                            </ol>
                        </nav>
    ...
    <?php echo $__env->make('dashboard.core.technicians.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('content'); ?>
                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                        ...
                        <tr>
                            ...
                            <th><?php echo e(__('dash.image')); ?></th>
                            <th>التخصص</th>
                            <th><?php echo e(__('dash.phone')); ?></th>
                            <th><?php echo e(__('dash.group')); ?></th>
    ...
    <?php echo $__env->make('dashboard.core.technicians.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#html5-extension').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('dashboard.core.technician.index')); ?>',
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
        ...
        $(document).on('click', '#edit-tech', function () {
            ...
            //
            let action = "<?php echo e(route('dashboard.core.technician.update', 'id')); ?>";
        ...
        $("body").on('change', '#customSwitchtech', function () {
            ...
            $.ajax({
                url: '<?php echo e(route('dashboard.core.technician.change_status')); ?>',
                type: 'get',
...
<?php echo $__env->make('dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/974206.cloudwaysapps.com/xzgdmzdxcn/public_html/resources/views/dashboard/core/technicians/index.blade.php ENDPATH**/ ?>