        ...
        <div class="row layout-top-spacing">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6" style="min-height: 400px;">
                    ...
                    <div class="col-md-12">
                        <form action="<?php echo e(route('dashboard.core.service.store')); ?>" method="post" class="form-horizontal"
                                ...
                                <div class="form-row mb-2">
                                    ...
                                    <div class="form-group type-col col-md-6">
                                        ...
                                        <select id="inputState" class="select2 type form-control"
                                                name="type">
                                            <option
                                                value="<?php echo e(\App\Enums\Core\ServiceType::fixed()->value); ?>"><?php echo e(\App\Enums\Core\ServiceType::fixed()->value); ?></option>
                                            <option
                                                value="<?php echo e(\App\Enums\Core\ServiceType::evaluative()->value); ?>"><?php echo e(\App\Enums\Core\ServiceType::evaluative()->value); ?></option>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="measurement_id" name="measurement_id" class="select2 form-control pt-1"
                                            ...
                                            <?php $__currentLoopData = $measurements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $measurement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($measurement->id); ?>"><?php echo e($measurement->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <label class="switch s-outline s-outline-info  mb-4 mx-4 mt-3 d-block w-50">
                                            ...
                                            <input type="checkbox" name="best_seller" id="best_seller" checked>
                                            <span class="slider round"></span>
                                        </label>
...
<?php echo $__env->make('dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/974206.cloudwaysapps.com/xzgdmzdxcn/public_html/resources/views/dashboard/core/services/create.blade.php ENDPATH**/ ?>