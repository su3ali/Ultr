                    ...
                    <ul class="nav nav-tabs mb-3" id="technicianTabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="tab-technical_data" data-toggle="tab" href="#technical_data"
                                role="tab" aria-controls="technical_data"
                                aria-selected="true">{{ __('dash.technical_data') }}</a>
                        </li>
                                ...
                                <tbody>
                                    @foreach ($visits as $visit)
                                        <tr>
                                            ...
                                            <th> {{ \Carbon\Carbon::parse($visit->start_time)->timezone('Asia/Riyadh')->format('g:i A') }}
                                            </th>
                                            <th> {{ \Carbon\Carbon::parse($visit->end_time)->timezone('Asia/Riyadh')->format('g:i A') }}
                                            </th>
