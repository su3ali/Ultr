...
{{--                        </button>--}}
                        ...
                        <a href="{{route('dashboard.core.icon.create')}}" id="" class="btn btn-primary card-tools">
                            {{__('dash.add_new')}}
                        </a>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#html5-extension').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route('dashboard.core.icon.index') }}',
                columns: [
                    {data: 'id', name: 'id'},
        ...
        $("body").on('change', '#customSwitch4', function () {
            ...
            $.ajax({
                url: '{{route('dashboard.core.icon.change_status')}}',
                type: 'get',
