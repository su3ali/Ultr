    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> {{ __('dash.add_complaint_type') }}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('dashboard.complaint_type.store')}}" method="post" class="form-horizontal"
