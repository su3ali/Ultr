        ...
        <ul class="navbar-item theme-brand flex-row  text-center">
            ...
            <li class="nav-item">
                <a href="{{route('dashboard.home')}}" class="nav-link logo">
                    <img src="{{ asset('images/w-logo.png') }}" class="flag-width" alt="flag">
                </a>
            </li>
            @endif
        ...
        <ul class="navbar-item flex-row ml-md-auto">
            ...
            <li class="nav-item dropdown language-dropdown">
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                    <a class="dropdown-item d-flex" href="{{route('dashboard.lang', 'ar')}}"><img
                            src="{{asset(app()->getLocale().'/assets/img/ksa-circle.png')}}" class="flag-width"
                            alt="flag">
                        <span class="align-self-center">&nbsp;English</span></a>
                </div>
                @endif
                                    ...
                                    {{--<div class="user-img">--}}
                                        {{--<div class="avatar avatar-xl">--}}
                                            {{--<span class="avatar-title rounded-circle">--}}
                                                {{--{{strtoupper(mb_substr($message->first_name, 0,
                                                1)).strtoupper(mb_substr($message->last_name, 0, 1))}}--}}
                                                {{--</span>--}}
                                            {{--</div>--}}
                                        {{--</div>--}}
                                    {{--<div class="media-body">--}}
                                        {{--<div class="">--}}
                                            {{--<h5 class="usr-name">{{$message->first_name.' '.$message->last_name}}
                                            </h5>--}}
                ...
                {{--<div class="dropdown-menu position-absolute" aria-labelledby="notificationDropdown">--}}
                    {{--<div class="notification-scroll">--}}
                        ...
                        {{--<a class="dropdown-item"
                            href="{{route('dashboard.core.notifications.show', $notify->id)}}">--}}
            ...
            <li class="nav-item dropdown user-profile-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown"
                    ...
                    <img src="{{auth('dashboard')->user()->avatar? : asset(app()->getLocale().'/assets/img/90x90.jpg')}}"
                        alt="avatar">
                </a>
                <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                    <div class="">
                        <div class="dropdown-item">
                            <a class=""
                                href="{{route('dashboard.core.administration.profile.edit', auth()->user()->id)}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
