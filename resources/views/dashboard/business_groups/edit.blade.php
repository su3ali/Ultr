<div class="modal fade " id="editGroupTechModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="post" class="form-horizontal" enctype="multipart/form-data"
                    id="edit_grouptech_form" data-parsley-validate="">
                    @csrf
                    {!! method_field('PUT') !!}
                    <div class="box-body">
                        ...
                        <div class="form-row mb-3">
                            <div class="form-group col-md-6">
                                ...
                                <select id="edit_technician_id" class="select2 form-control pt-1" name="technician_id">
                        ...
                        <div class="form-row mb-3">
                            <div class="form-group col-md-6">
                                ...
                                <select id="country_id" class=" country_id form-control pt-1" name="country_id">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="city_id" class=" city_id form-control pt-1" name="city_id">
                                    <option disabled>{{__('dash.choose')}}</option>
