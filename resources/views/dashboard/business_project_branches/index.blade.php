...
@include('dashboard.business_project_branches.create')
@endsection
...
@include('dashboard.business_project_branches.edit')
...
<script type="text/javascript">
    ...
    // تنظيف كل الاختيارات أولاً
    $('#edit_client_project_id').val('').trigger('change');

    // تحديد المشروع من القيمة المرسلة
    $('#edit_client_project_id option').each(function () {
    ...
    // إذا تستخدم select2
    $('#edit_client_project_id').trigger('change');
