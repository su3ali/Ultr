        ...
        $(document).ready(function() {
            var table = $('#html5-extension').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        d.status = $('.status_filter').val(); // Pass the selected status to the server
                    }
                },
                columns: [{
                        data: 'id',
            ...
            // Update table data when the status filter changes
            $('.status_filter').change(function() {
                table.ajax.reload(); // Reload table data based on the selected status
            });
        });
    </script>
@endpush
