...
@section('sub-header')
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-2">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{__('dash.car_type')}}</li>
                            </ol>
                        </nav>
    ...
    @include('dashboard.car_type.create')
@endsection
...
@section('content')
    ...
    @include('dashboard.car_type.edit')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#html5-extension').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route('dashboard.car_type.index') }}',
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
