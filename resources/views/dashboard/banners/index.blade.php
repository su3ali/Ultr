    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#html5-extension').DataTable({
                ...
                "oLanguage": {
                    'sEmptyTable': "{{ __('dash.no_data_available_in_table') }}",
                    'sInfo': "{{ __('dash.Showing') }}" + ' _START_ ' + "{{ __('dash.to') }}" + ' _END_ ' +
                        "{{ __('dash.of') }}" + ' _TOTAL_ ' + "{{ __('dash.entries') }}",
                    'sInfoEmpty': "{{ __('dash.Showing') }}" + ' 0 ' + "{{ __('dash.to') }}" + ' 0 ' +
                        "{{ __('dash.of') }}" + ' 0 ' + "{{ __('dash.entries') }}",
                    'sInfoFiltered': '(' + "{{ __('dash.filtered') }}" + ' ' + "{{ __('dash.from') }}" +
                        ' _MAX_ ' + "{{ __('dash.total') }}" + ' ' + "{{ __('dash.entries') }}" + ')',
                    'sInfoThousands': ',',
