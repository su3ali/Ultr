                    ...
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 py-2">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{route('dashboard.contract_order.index')}}">{{__('dash.package_request')}}</a>
                            </li>
                ...
                <div class="col-md-12">
                    <form action="{{route('dashboard.contract_order.store')}}" method="post" class="form-horizontal"
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-xl-12 col-lg-12 col-sm-12 reservition  layout-spacing"
                                style="display:none;">
                            ...
                            <div class="widget-content widget-content-area m-3 mt-0">
                                <div class="form-row  card bg-light-dark m-3">
                                    <div class="form-group col-md-12 mt-2">
                                        ...
                                        <input hidden name="price" id="totalafterdiscount" class="form-control">
