            ...
            <div class="widget-content widget-content-area br-6" style="min-height: 400px;">
                ...
                <div class="col-md-12">
                    <form action="{{route('dashboard.orders.update', $order->id)}}" method="post"
                        class="form-horizontal" enctype="multipart/form-data" id="edit_order_form"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-row mb-3">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input required type="number" step="0.1" name="price" class="form-control"
                                        id="edit_price" placeholder="{{__('dash.price')}}">
                                    @error('price')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-row mb-3">
                                <div class="form-group">
                                    {{ html()->label(__('dash.payment_method'))->for('edit_payment_method_visa') }}
                                    <div class="">
                                        <label class="radio-inline">
                                            <input class="mx-2" value="visa" type="radio" name="payment_method"
                                                id="edit_payment_method_visa" checked>دفع إلكتروني
                                        </label>
                                        <label class="radio-inline">
                                            <input class="mx-2" value="cache" type="radio" name="payment_method"
                                                id="edit_payment_method_cache">دفع نقدي
                                        </label>
                                    </div>
                            ...
                            <div class="form-row mb-3">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="notes" id="edit_notes" cols="30" rows="3"
