                    ...
                    <form action="{{ route('dashboard.coupons.store') }}" method="post" class="form-horizontal"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-row mb-3">
                                ...
                                <div class="col-md-4 custom-file-container form-group" data-upload-id="mySecondImage">
                            ...
                            <div class="form-row mb-2">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="number" step="0.1" name="value" class="form-control" id="value"
                            ...
                            <div class="form-row mb-2">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="times_limit" class="form-control" id="times_limit"
                                            placeholder="أدخل العدد">
                                        @error('times_limit')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
