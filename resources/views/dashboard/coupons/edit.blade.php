                ...
                <div class="page-header">
                    ...
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 py-2">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.coupons.index') }}">الكوبونات</a>
                            </li>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-row mb-3">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="title_ar" class="form-control" id="title_ar"
                                        value="{{ $coupon->title_ar }}" placeholder="أدخل العنوان" required>
                                    @error('title_ar')
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="title_en" class="form-control" id="title_en"
                                        value="{{ $coupon->title_en }}" placeholder="أدخل العنوان" required>
                                    @error('title_en')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>

                                <div class="col-md-4 custom-file-container form-group" data-upload-id="myImage">
                            ...
                            <div class="form-row mb-0 pb-0">
                                <div class="form-group mb-0 col-md-4 pt-1">
                                    <label for="" style="padding-left: 14px; padding-right: 14px">نطاق الخصم :
                                    </label>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="edit_category_id" {{ !$coupon->category_id ? 'disabled' : '' }}
                                        class="select2 form-control pt-1" name="category_id">
                                        <option selected disabled>{{ __('dash.choose') }}</option>
                                        @foreach ($categories as $category)
                                        <option value="{{ $category->id }}" {{ $coupon->category_id == $category->id ?
                                            'selected' : '' }}>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="edit_service_id" {{ !$coupon->service_id ? 'disabled' : '' }}
                                        class="select2 form-control pt-1" name="service_id">
                                        <option selected disabled>{{ __('dash.choose') }}</option>
                                        @foreach ($services as $service)
                                        <option value="{{ $service->id }}" {{ $coupon->service_id == $service->id ?
                                            'selected' : '' }}>
                            ...
                            <div class="form-row mb-2">
                                <div class="form-group col-md-3">
                                    ...
                                    <select required class="form-control" style="width: 100%; padding: 8px" name="type">
                                        <option value="percentage" {{ $coupon->type == 'percentage' ? 'selected' : ''
                                            }}>نسبة</option>
                                        <option value="static" {{ $coupon->type == 'static' ? 'selected' : '' }}>مبلغ
                                            ثابت</option>
                                    </select>
                                    @error('type')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="number" step="0.1" name="value" class="form-control" required
                                        id="value" value="{{ $coupon->value }}" placeholder="أدخل القيمة">
                                    @error('value')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input required name="start" type="date" class="form-control datepicker"
                                        value="{{ $coupon->start }}" data-date-format="dd/mm/yyyy">
                                    @error('start')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input required name="end" type="date" class="form-control datepicker"
                                        value="{{ $coupon->end }}" data-date-format="dd/mm/yyyy">
                                    @error('end')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="user_times" class="form-control" id="user_times"
                                            value="{{ $coupon->user_times }}" placeholder="أدخل العدد">
                                        @error('user_times')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="times_limit" class="form-control"
                                            value="{{ $coupon->times_limit }}" id="times_limit"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="code" class="form-control" id="edit_code"
                                            placeholder="أدخل الكود" value="{{ $coupon->code }}">
                                        @error('code')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="form-row mb-2">
                                <div class="form-group col-md-6">
                                    ...
                                    <label class="switch s-outline s-outline-info  mb-4 mx-4 mt-3 d-block w-50">
                                        ...
                                        <input type="checkbox" name="is_hidden" id="is_hidden" {{ $coupon->is_hidden ==
                                        1 ? 'checked' : '' }}>
                            ...
                            <div class="form-row mb-3">
                                <div class="form-group col-md-6">
                                    <label class="d-block mb-2">الفئة المستهدفة :</label>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="is_employee_only"
                                            id="customerOption" value="0" {{ $coupon->is_employee_only == 0 ? 'checked'
                                        : '' }}>
                                        <label class="form-check-label" for="customerOption">العملاء</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="is_employee_only"
                                            id="employeeOption" value="1" {{ $coupon->is_employee_only == 1 ? 'checked'
                                        : '' }}>
                                        <label class="form-check-label" for="employeeOption">الموظفين فقط</label>
                                    </div>
