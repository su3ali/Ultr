                ...
                <form method="post" action="{{route('dashboard.settings')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 layout-top-spacing">
                            <x-forms.input :type="'text'" :value="$settings->site_name_ar" :name="'site_name_ar'"
                                :class="'form-control'" :label="__('dash.site_name_arabic')" />
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 layout-top-spacing">
                            <x-forms.input :type="'text'" :value="$settings->site_name_en" :name="'site_name_en'"
                                :class="'form-control'" :label="__('dash.site_name_english')" />
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 layout-top-spacing">
                            <x-forms.input :type="'text'" :value="$settings->google_api_key" :name="'google_api_key'"
                                :class="'form-control'" :label="'google api key'" />
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 layout-top-spacing">
                            <x-forms.input :type="'text'" :value="$settings->phone" :name="'phone'"
                                :class="'form-control'" :label="__('dash.phone')" />
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 layout-top-spacing">
                            <x-forms.input :type="'text'" :value="$settings->whats_app" :name="'whats_app'"
                                :class="'form-control'" :label="__('رقم الواتس اب')" />
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 layout-top-spacing">
                            <x-forms.input :type="'text'" :value="$settings->email" :name="'email'"
                                :class="'form-control'" :label="__('dash.email')" />
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-3 col-sm-12 layout-top-spacing">
                            <div class="col-md-12 custom-file-container form-group" data-upload-id="mySecondImage">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input required name="resting_start_time" value="{{$settings->resting_start_time}}"
                                type="time" class="form-control " data-date-format="h:i">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input required name="resting_end_time" value="{{$settings->resting_end_time}}" type="time"
                                class="form-control " data-date-format="h:i">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <label class="switch s-outline s-outline-info  mb-4 mx-4 mt-3 d-block w-50">
                                ...
                                <input type="checkbox" @if($settings->is_resting == 1) checked @endif name="is_resting"
                                id="is_resting">
