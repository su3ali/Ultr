...
@section('sub-header')
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-2">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{__('dash.Countries')}}</li>
                            </ol>
                        </nav>
    ...
    @include('dashboard.settings.countries.create')
@endsection
...
@section('content')
    ...
    @include('dashboard.settings.countries.edit')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#html5-extension').DataTable({
                ...
                processing: true,
                 serverSide: false,
                ajax: '{{ route('dashboard.country.index') }}',
                columns: [
                    {data: 'id', name: 'id'},
        ...
        $("body").on('change', '#customSwitch4', function () {
            ...
            $.ajax({
                url: '{{route('dashboard.country.change_status')}}',
                type: 'get',
