                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-2">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('dashboard.region.index')}}">{{__('dash.Region')}}</a></li>
...
@push('script')
    ...
    <script type="text/javascript" async defer
            src="https://maps.google.com/maps/api/js?key={{ Config::get('app.GOOGLE_MAP_KEY') }}&libraries=drawing&callback=initMap"></script>
@endpush
