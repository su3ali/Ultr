                ...
                <div class="page-header">
                    ...
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 py-2">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.bookings.index') }}">{{
                                    __('dash.bookings') }}</a>
                            </li>
                            ...
                            <div class="form-row mb-3">
                                <div class="form-group col-md-6">
                                    ...
                                    <select required class="select2 form-control pt-1" name="order_id">
                                        ...
                                        <option value="{{ $order->id }}" {{ $booking->order_id == $order->id ?
                                            'selected' : '' }}>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select required id="customer_name" class="select2 form-control pt-1"
                                        ...
                                        <option value="{{ $customer->id }}" {{ $booking->user_id == $customer->id ?
                                            'selected' : '' }}>
                            ...
                            <div class="form-row mb-3">
                                <div class="form-group col-md-6">
                                    ...
                                    <select required class="select2 form-control pt-1" name="service_id">
                                        ...
                                        <option value="{{ $service->id }}" {{ $booking->service_id == $service->id ?
                                            'selected' : '' }}>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select required class="select2 form-control pt-1" name="group_id">
                                        ...
                                        <option value="{{ $group->id }}" {{ $booking->group_id == $group->id ?
                                            'selected' : '' }}>
                                            {{ $group->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-row mb-3">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select required class="select2 form-control pt-1" name="booking_status_id">
                                        ...
                                        <option value="{{ $status->id }}" {{ $booking->booking_status_id == $status->id
                                            ? 'selected' : '' }}>
                                            {{ $status->name }}</option>
                                        @endforeach
                                    </select>
