...
class IndexController extends Controller
{
    ...
    protected function index()
    {
        ...
        return view('dashboard.home', compact('canceled_orders', 'customersHaveOrders', 'canceled_orders_today', 'tech_visits_today', 'finished_visits_today', 'total_trainees', 'client_orders_today', 'sells_chart_1', 'sells_chart_2', 'customers', 'client_orders', 'technicians', 'tech_visits','customer_complaints'));
    }
